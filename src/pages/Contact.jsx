...
const Contact = () => {
  return (
    <>
    <div id="contact-section" className="py-10 bg-black playwrite-gb-s-regular ">
  ...
  <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-500 via-blue-500 to-blue-500 bg-clip-text text-transparent">
